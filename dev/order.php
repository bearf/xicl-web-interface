...
header('Location: '. ServerRoot . 'team/update/');
...
// �������� �� ��, ��� ������� ������� ����������
if (1 != $is_admin):
    $q = $mysqli_->prepare('select count(*) from teams T where T.teamid=?');
    $q->bind_param('i', $curteamid);
    $q->bind_result($tmp);
    if (!$q->execute()) { fail(_error_mysql_query_error_code); } // auto-close query
    $q->fetch();
    $q->close();
    if (0 == $tmp) { fail(_error_no_team_found_code); }
endif;
// ����� �������� �� ��, ��� ������� ������� ����������

// �������� �� ������� �����������
if (1 != $is_admin):
    $q = $mysqli_->prepare('select count(*) from teams T where T.teamid=? and T.invited=1');
    $q->bind_param('i', $curteamid);
    $q->bind_result($tmp);
    if (!$q->execute()) { fail(_error_mysql_query_error_code); } // auto-close query
    $q->fetch();
    $q->close();
    if (0 == $tmp) { fail(_error_your_team_is_not_invited_code); }
endif;
// ����� �������� �� ������� �����������

$city = isset($city) ? $city : '';
$studyplace = isset($studyplace) ? $studyplace : '';
$address = isset($address) ? $address : '';
$phone = isset($phone) ? $phone : '';
$fax = isset($fax) ? $fax : '';
$contactname = isset($contactname) ? $contactname : '';
$contactphone = isset($contactphone) ? $contactphone : '';
$contactmail = isset($contactmail) ? $contactmail : '';

$contestant1name = isset($contestant1name) ? $contestant1name : '';
$contestant1studyplace = isset($contestant1studyplace) ? $contestant1studyplace : '';
$contestant1classcourse = isset($contestant1classcourse) ? $contestant1classcourse : '';
$contestant1birthdate = isset($contestant1birthdate) ? $contestant1birthdate : '';
$contestant1address = isset($contestant1address) ? $contestant1address : '';
$contestant1inn = isset($contestant1inn) ? $contestant1inn : '';
$contestant1passportno = isset($contestant1passportno) ? $contestant1passportno : '';
$contestant1passportplace = isset($contestant1passportplace) ? $contestant1passportplace : '';
$contestant1passportdate = isset($contestant1passportdate) ? $contestant1passportdate : '';

$contestant2name = isset($contestant2name) ? $contestant2name : '';
$contestant2studyplace = isset($contestant2studyplace) ? $contestant2studyplace : '';
$contestant2classcourse = isset($contestant2classcourse) ? $contestant2classcourse : '';
$contestant2birthdate = isset($contestant2birthdate) ? $contestant2birthdate : '';
$contestant2address = isset($contestant2address) ? $contestant2address : '';
$contestant2inn = isset($contestant2inn) ? $contestant2inn : '';
$contestant2passportno = isset($contestant2passportno) ? $contestant2passportno : '';
$contestant2passportplace = isset($contestant2passportplace) ? $contestant2passportplace : '';
$contestant2passportdate = isset($contestant2passportdate) ? $contestant2passportdate : '';

$contestant3name = isset($contestant3name) ? $contestant3name : '';
$contestant3studyplace = isset($contestant3studyplace) ? $contestant3studyplace : '';
$contestant3classcourse = isset($contestant3classcourse) ? $contestant3classcourse : '';
$contestant3birthdate = isset($contestant3birthdate) ? $contestant3birthdate : '';
$contestant3address = isset($contestant3address) ? $contestant3address : '';
$contestant3inn = isset($contestant3inn) ? $contestant3inn : '';
$contestant3passportno = isset($contestant3passportno) ? $contestant3passportno : '';
$contestant3passportplace = isset($contestant3passportplace) ? $contestant3passportplace : '';
$contestant3passportdate = isset($contestant3passportdate) ? $contestant3passportdate : '';

$headname = isset($headname) ? $headname : '';
$headpost = isset($headpost) ? $headpost : '';
$headbirthdate = isset($headbirthdate) ? $headbirthdate : '';
$headaddress = isset($headaddress) ? $headaddress : '';
$headinn = isset($headinn) ? $headinn : '';
$headpassportno = isset($headpassportno) ? $headpassportno : '';
$headpassportplace = isset($headpassportplace) ? $headpassportplace : '';
$headpassportdate = isset($headpassportdate) ? $headpassportdate : '';

$coachname = isset($coachname) ? $coachname : '';
$coachpost = isset($coachpost) ? $coachpost : '';
$coachbirthdate = isset($coachbirthdate) ? $coachbirthdate : '';
$coachaddress = isset($coachaddress) ? $coachaddress : '';
$coachinn = isset($coachinn) ? $coachinn : '';
$coachpassportno = isset($coachpassportno) ? $coachpassportno : '';
$coachpassportplace = isset($coachpassportplace) ? $coachpassportplace : '';
$coachpassportdate = isset($coachpassportdate) ? $coachpassportdate : '';

$codegamechallenge = isset($codegamechallenge) && $codegamechallenge ? 1 : 0;

// ��������?
if (isset($submitbtn)):
    $q_str = 'insert into orders(teamid, orderdate'
    ...
    $q->bind_param('isssssisssssissssssssissssssssissssssssssssssssssssss',
        $curteamid, 
        $city, $studyplace, $address, $phone, $fax, $codegamechallenge,
        $contactname, $contactphone, $contactmail,
        $contestant1name, $contestant1studyplace, $contestant1classcourse, 
    ...
    if (!$q->execute() || 0 == $q->affected_rows) { fail(_error_mysql_query_error_code); } // auto-close query
    
    data('message', $messages[_success_order_sent]);
    
    notify(
        -1, $curteamid,
        '����������� ������',
        '������������ <a href="./userinfo.php?userid='.$curuserid.'">'.$curnickname.'</a> ������� �������� <a href="./order.php">��������������� ������</a> �� ����� ����� �������.'
        ,true
    );
endif; // ����� ��������
