<?php
  ...
  define('_system_site_title', 'архив олимпиадных задач');

  define("IsLoginNeed", 0);
  define('_permission_is_user_data_secure', false);
  ...
  define('_permission_allow_view_news', true);
  
  define('_settings_show_main_site_url', true);
